...
contract FundsManager is ReentrancyGuard {
    ...
    function deposit(uint256 _amount) public payable {
        require(
            msg.value == _amount,
            "[Failed] Funds Manager Contract: deposit function: Incorrect input"
        );
        ...
        nonReentrant
    {
        ...
        require(
            success,
            "[Failed] Funds Manager Contract: withdraw function: Withdraw failed"
        );
    }
        ...
        nonReentrant
    {
        ...
        require(
            success,
            "[Failed] Funds Manager Contract: externalWithdraw function: Call failed"
        );
    }
        ...
        onlyAuthor(_to)
    {
        ...
        require(
            success,
            "[Failed] Funds Manager Contract: transfer function: Call failed"
        );
    }
...
contract ExternalContract {
    ...
    function deposit(address _to, uint256 _amount) external payable {
        ...
        require(
            success,
            "[Failed] External Contract: deposit function: Deposit failed"
        );
    }
